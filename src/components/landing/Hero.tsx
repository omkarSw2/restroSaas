      ...
      <section className="relative px-8 py-10 max-w-7xl mx-auto overflow-hidden">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <div className="relative z-10 rounded-4xl overflow-hidden shadow-2xl transition-transform duration-500">
              <Image
                alt="Modern POS Dashboard"
                width={800}
                height={600}
                className="w-full h-auto object-cover aspect-4/3"
                src="/images/HeroImage04.jpeg"
                priority
              />
            </div>
...
//          The TechResto heartbeat of your business. Seamlessly manage orders,
//          inventory, and payments with the industry&apos;s fastest interface.
//        </p>
//        <div className="flex flex-col sm:flex-row gap-4">
//          <Link
//            href="#contact"
//            className="px-8 py-4 rounded-xl techresto-gradient text-white font-bold text-lg shadow-xl shadow-primary/20 hover:shadow-primary/40 transition-all active:scale-95 flex items-center justify-center"
//          >
//            Get Started
//          </Link>
//          <Link
//            href="#contact"
//            className="px-8 py-4 rounded-xl bg-surface-container-highest text-on-surface font-bold text-lg hover:bg-surface-container-high transition-all active:scale-95 flex items-center justify-center"
//          >
//            Book a Demo
//          </Link>
//        </div>
