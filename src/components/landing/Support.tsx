        ...
        <div className="bg-surface-container-lowest rounded-3xl p-12 lg:p-20 shadow-sm grid lg:grid-cols-2 gap-16 items-center border border-outline-variant/10">
          ...
          >
            <h2 className="font-headline text-4xl lg:text-5xl font-extrabold mb-6 leading-tight text-on-surface">
              24/7 Support & <span className="text-primary font-bold">Always-On</span> Training
            </h2>
            <p className="text-on-surface-variant text-lg mb-10 leading-relaxed">
              We don&apos;t just sell software; we&apos;re your partner in success. Get live human assistance anytime, plus a library of training for your new hires.
            </p>
            <ul className="space-y-4 mb-10">
              <li className="flex items-center gap-3">
                <span className="material-symbols-outlined text-primary">check_circle</span>
                <span className="font-semibold text-on-surface">Local on-site installation</span>
              </li>
              <li className="flex items-center gap-3">
                <span className="material-symbols-outlined text-primary">check_circle</span>
                <span className="font-semibold text-on-surface">Live phone support in &lt; 30 seconds</span>
              </li>
              <li className="flex items-center gap-3">
                <span className="material-symbols-outlined text-primary">check_circle</span>
                <span className="font-semibold text-on-surface">Interactive video onboarding</span>
              </li>
            </ul>
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <motion.img 
              ...
              src="https://lh3.googleusercontent.com/aida-public/AB6AXuDW5oxADma81YV16J5eQviuB-t4f4RMA0mG8tdcNyv3gWZq6PJkk2c8vppwoIw3GtF2B7wRFErT28WR40ZBXJbOn3D4p42RU_HqJmGCrowt0qweMIAGKY5rBqerRK5fqTVvN6nwCLV3WyqRVqLC3SgUxiWKt_0p0zGeDuOS0-xcn4Q6wI0P4VD3qcIyJUqBJWhuXSW9l_X6Gbw0h0pv1i9vEuUG0FMPL-zrSFPERZ_kLPcQOJJOzjtJArdRHd_svxwcxz-9Gv2j2wU"
            />
          </div>
        </div>
      </div>
